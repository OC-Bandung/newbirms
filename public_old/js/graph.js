$(document).ready(function() {
       ...
       var options = {
        ...
        $.getJSON("api/graph/1", function(list) {
          var newseries;
...
$(document).ready(function() {
       ...
       $.getJSON("api/graph/2/"+$currYear, function(list) {
    ...
    $(document).ready(function() {
       ...
       $.getJSON("api/graph/3/"+$currYear, function(list) {
          var newdata;
    ...
    $(document).ready(function() {
       ...
       var options = {
        ...
        $.getJSON("api/graph/4", function(list) {
          var newseries;
